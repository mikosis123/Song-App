...
const TableContaints = ({
  ...
  return (
    <tr className=" bg-[#e5e5e5] w-full border-t border-gray-300 hover:bg-white dark:bg-gray-800 dark:border-gray-700">
      <th>
      ...
      >
        ...
        {isEditing && (
          <input
            className="bg-gray-50 mx-4 mt-8 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  w-[150px] ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            type="text"
            name="Title"
